...
def vglubiny():
    ...
    #генерация словаря смежности вершин (если он не введен с клавиатуры)
    ...
    #вывод
    final_output="Случайносгенерированный словарь смежности вершин:  <br>  " + str(graph0) + " <br><br> Порядок обхода: <br> " + str(visited) + "<br><br> Обход был начат в вершине: <br> " + str(strt2)+""
    return(final_output)
